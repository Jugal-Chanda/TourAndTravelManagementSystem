...
(3, 1, 1, 0, 3, 2, 12000, '2019-04-08', '2019-04-10', 0),
(4, 1, 1, 0, 3, 2, 12000, '2019-04-02', '2019-04-04', 0),
...
INSERT INTO `information` (`profile_image`, `name`, `user_name`, `email`, `age`, `payment_type`, `account_number`, `password`, `user_id`) VALUES
('blankimage.jpg', 'jugal', 'jugal', 'jugalchanda1997@gmail.com', 22, 'dbbl', 1521461643, '123456', 1);
...
--
-- Dumping data for table `information_admin`
--

INSERT INTO `information_admin` (`profile_image`, `name`, `user_name`, `email`, `age`, `phone_number`, `password`, `admin_id`) VALUES
('profile_image_admin1.jpg', 'ttm', 'ttm', 'ttm@gmail.com', 10, '01521461643', '123456', 1);
